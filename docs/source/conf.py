#
# Sphinx configuration for aiida-grouppathx
#
...
release = aiida_grouppathx.__version__
...
html_title = f"aiida-grouppathx v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-grouppathx.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_grouppathx")
